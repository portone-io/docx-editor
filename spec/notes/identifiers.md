...
An entry the part writes back as the bytes it arrived as - a footnote separator, a continuation notice - claims every name it holds ahead of the stories written again, since nothing standing in those bytes can yield.
