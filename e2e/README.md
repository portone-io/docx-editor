...
| `notesEditing.spec.ts` | Typing, formatting and undo inside a footnote, hangul composition across a relayout, Escape returning the caret, and footnote insertion from the right-click menu and from its shortcut |
