...
Each page is now as tall as the body its own section leaves, a section break always starts a new
page, and a table is fitted to the body width of the section it is inserted or dragged in. A page
number still carries on across a section boundary rather than restarting where the section asks.
...
keeps the width it was given. The kind of start a section declares - continuous, even page, odd
page - is preserved and exported untouched, but every section is drawn as a new page.
