...
Formatting properties keep the line breaks, comments and text a producer wrote between and inside them, so rewriting one no longer drops them, whether it is a run's bold, a paragraph's alignment, or a cell of a rebuilt table.
