...
If an existing numbering relationship points to a missing part, the new definition is written at that location so the document can find the list when reopened.
