...
| Tracked changes | Existing revision markup is preserved but not displayed or editable. A rebuilt table is the exception: it loses its `w:tblGridChange`, and the properties of the cells continuing a vertical merge. |
