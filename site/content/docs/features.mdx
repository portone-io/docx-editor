...
| Bookmarks | Existing bookmark ranges are preserved at their document positions but are not displayed or editable. Commands that would remove a marker report that they do not apply. |
