...
The comparison covers the whole package:
...
Three things the editor rebuilds are not compared: a table's `w:gridCol` list, a drawing's extent,
and table properties the model no longer needs.
...
ownership rule the verdict holds to.
