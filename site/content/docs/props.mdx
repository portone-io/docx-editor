...
Give each `id` a distinct `name` within the document. Reusing a name can make comments
unattributed or fail [server verification](/docs/core/verifying-a-commenters-file).
